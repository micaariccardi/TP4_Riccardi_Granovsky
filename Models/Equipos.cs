...
{
    public static List<string> listaEquipos {get; private set;} = new List<string> {"Boca","River", "San Lorenzo", "Independiente", "Racing", "Sacachispas", "Huracán", "Argentina Jrs.", "Banfield", "Veléz"};
    ...
    public static Dictionary <string, Indumentaria> IndumentariaEquipos {get; private set;}
